...
{	
	PORTC.DIRSET = 0b00110000;		//Set pins as output
	...
	PORTC.INTCTRL = 0b00001010;	//INT1LVL(10) + INT0LVL(10)	p.101
...
{	
	//Werkt niet altijd even goed. Dit komt o.a. doordat de draaiknop niet ontdenderd wordt. 
